/**
 * QuestCalculator based on Maps. This implementation matched the one described in the PRDualRank paper. Performs well for sparse graphs. For fully-connected graphs @see MatrixBasedQuestCalculator
 * 
 * <br>
