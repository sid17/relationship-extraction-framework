...
/**
 * The Class Recall computes recall. Recall is the ratio between
 * the number of true positives and the number of positives returned
 * by the model.
 *
 *
 * @author      Pablo Barrio
 ...
 * @since       2011-09-27
 */
public class Recall implements Measure {
	
	/** The true positives. */
	private Measure truePositives = new NumberOfTruePositives();
	
	/** The number positives. */
	private Measure numberPositives = new NumberOfExpectedPositiveAnswers();
